...
class ModelGraphQLConfig(Base):
    ...
    order_by_expression_type: Mapped[str] = mapped_column(String(255))
    ...
    def from_json(cls: Type["ModelGraphQLConfig"], json_data: Dict[str, Any],
        ...
        config = cls(
            ...
            filter_input_type_name=json_data["filterInputTypeName"],
            order_by_expression_type=json_data["orderByExpressionType"],
        ...
        for unique_data in json_data.get("selectUniques", []):
            for identifier in unique_data["uniqueIdentifier"]:
